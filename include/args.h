...
DECLARE_string(det_onnx_input_name);
DECLARE_string(det_onnx_output_name);
...
DECLARE_string(cls_onnx_input_name);
DECLARE_string(cls_onnx_output_name);
...
DECLARE_string(rec_onnx_input_name);
DECLARE_string(rec_onnx_output_name);
